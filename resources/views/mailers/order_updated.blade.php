                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<img src="{{url('img/logo-nav-bar.png')}}" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Nueva informacion de tu pedido</h1>
                                                                <strong>Hola! {{$order->email}}:</strong> 
                                                                Se actualizo la informacion de tu pedido, aqui te presentamos los datos actualizados:
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                <a href="mailto:petmomentssupport@gmail.com">
                                                                petmomentssupport@gmail.com
                                                                </a>
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                    	<td align="center" valign="top" style="padding-top:0;">
                                                        	<table border="0" cellpadding="15" cellspacing="0" class="btn btn-success">
                                                            	<tr>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2017 PETMOMENTS, All rights reserved.</em>
																<br />
